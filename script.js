...
sortBooks.addEventListener('change', () => {
  ...
  if (sortValue === 'yearAsc') {
    ...
    sortedBooks.sort((a, b) => a.author.split(" ").slice(-1)[0].localeCompare(b.author.split(" ").slice(-1)[0]));
  } else if (sortValue === 'nameDesc') {
    sortedBooks.sort((a, b) => b.author.split(" ").slice(-1)[0].localeCompare(a.author.split(" ").slice(-1)[0]));
  } else if (sortValue === 'bookNameAsc') {
    sortedBooks.sort((a, b) => a.title.localeCompare(b.title));
  } else if (sortValue === 'bookNameDesc') {
